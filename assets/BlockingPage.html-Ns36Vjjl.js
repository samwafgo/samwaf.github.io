import{_ as n}from"./blocking_page-f9H9atCu.js";import{_ as s}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as a,c as t,e as p}from"./app-9DklAFkt.js";const e={},o=p('<h1 id="custom-blocking-response-page" tabindex="-1"><a class="header-anchor" href="#custom-blocking-response-page" aria-hidden="true">#</a> Custom BlockIng Response Page</h1><h2 id="_1-custom-blocking-response-page" tabindex="-1"><a class="header-anchor" href="#_1-custom-blocking-response-page" aria-hidden="true">#</a> 1 Custom BlockIng Response Page</h2><h3 id="_1-1-custom-blocking-response-page" tabindex="-1"><a class="header-anchor" href="#_1-1-custom-blocking-response-page" aria-hidden="true">#</a> 1.1 Custom BlockIng Response Page</h3><figure><img src="'+n+`" alt="Custom BlockIng Response Page" tabindex="0" loading="lazy"><figcaption>Custom BlockIng Response Page</figcaption></figure><ul><li><p><strong>Custom BlockIng Response Page Name</strong>: Used for identification.</p></li><li><p><strong>Website</strong>: Normally, select the global website. However, if each website needs a specific response, choose the specific website.</p></li><li><p><strong>Response Code</strong>: Default is 403, but you can edit it based on your requirements.</p></li><li><p><strong>Response Content</strong>: The content that is returned to the visitor. Supports variables:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Visit ID:  
[[.SAMWAF_REQ_UUID]]
