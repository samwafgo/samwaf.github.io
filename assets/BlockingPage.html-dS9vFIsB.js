import{_ as i}from"./blocking_page-f9H9atCu.js";import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as e,c as d,e as l}from"./app-ZBnKaqIh.js";const s={},a=l('<h1 id="自定义拦截响应界面" tabindex="-1"><a class="header-anchor" href="#自定义拦截响应界面" aria-hidden="true">#</a> 自定义拦截响应界面</h1><h2 id="_1-自定义拦截响应界面" tabindex="-1"><a class="header-anchor" href="#_1-自定义拦截响应界面" aria-hidden="true">#</a> 1 自定义拦截响应界面</h2><p>自定义拦截响应界面</p><h3 id="_1-1-自定义拦截界面" tabindex="-1"><a class="header-anchor" href="#_1-1-自定义拦截界面" aria-hidden="true">#</a> 1.1 自定义拦截界面</h3><figure><img src="'+i+`" alt="自定义拦截界面" tabindex="0" loading="lazy"><figcaption>自定义拦截界面</figcaption></figure><ul><li>自定义拦截模板页面名称 供自己识别</li><li>网站 正常选择全局网站即可,当然如果每个网站的返回要特殊处理，那么就选择特定的网站。</li><li>响应代码 ，默认403，可以依据实际情况进行编辑</li><li>响应内容 ，给访客返回的内容信息。支持变量：</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>访问ID码：
[[.SAMWAF_REQ_UUID]]
