...
::: tip 每个页面顶部都有一条说明条
管理端每个功能页顶部都有一条蓝色说明条，一句话讲清这个页面是做什么的。说明较多的页面右侧会有 **详细说明**：内容不多时原地展开，内容较多时从右侧滑出面板。面板里还有 **查看完整文档** 链接，直达本手册对应章节（界面切成英文时会自动打开英文文档）。
:::
...
## 通知管理
- [通知渠道](./NotifyChannel.md)
- [通知订阅](./NotifySubscription.md)
- [通知日志](./NotifyLog.md)
